...
#define SMART_DATA_GET(o, ptr)                           \
   Pe_Smart_Data *ptr = evas_object_smart_data_get(o)    \
...
static Pe_Smart_Data *_mouse_in_po = NULL;
...
{
   EVAS_SMART_DATA_ALLOC(obj, Pe_Smart_Data);
...
static void
_touch_down(Pe_Smart_Data *sd, unsigned int timestamp, int device, int x, int y)
{
   pepper_efl_shell_surface_t *shsurf;
   int rel_x, rel_y;
...
static void
_touch_up(Pe_Smart_Data *sd, unsigned int timestamp, int device)
{
   pepper_efl_shell_surface_t *shsurf;
...
static void
_touch_move(Pe_Smart_Data *sd, unsigned int timestamp, int device, int x, int y)
{
   pepper_efl_shell_surface_t *shsurf;
   int rel_x, rel_y;
...
static void
_pepper_efl_object_setup(Pe_Smart_Data *sd)
{
